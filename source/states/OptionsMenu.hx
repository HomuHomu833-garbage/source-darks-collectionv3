...
class OptionsMenu extends MusicBeatState {
	...
	public var pages:Map<String, Array<Option>> = [
		"Categories" => [
			new PageOption("DC Options", "DC Options","Dark's Collection Options"),
		...
		"Gameplay" => [
			...
			new BoolOption("Freeplay Black BG", "FreeplayBlackBG","Black BG in Freeplay"),
		...
		"DC Options" => [
			...
			new BoolOption("Gradient TimeBar", "gradientTimeBar","Gradient in Timebar"),
			new BoolOption("BG Renders", "renderBGs","Disable BG Renders in freeplay"),
			new BoolOption("Renders", "renders","Disable Renders in freeplay")
		],
		#if MODDING_ALLOWED
