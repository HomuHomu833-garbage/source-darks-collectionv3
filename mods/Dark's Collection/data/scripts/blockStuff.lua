...
function transOutState()
    if state == 'shield' then 
        ...
        tweenActorProperty('dadCharacter0', 'x', defaultMattX+(pushDist*5), stepCrochet*0.001*4, 'cubeOut')
        tweenActorProperty('mattShield', 'alpha', 0, stepCrochet*0.001*4, 'cubeOut')
        tweenActorProperty('bfCharacter0', 'x', defaultBFX+(pushDist*5), stepCrochet*0.001*4, 'cubeOut')
    elseif state == 'bfshield' then 
        ...
        tweenActorProperty('bfShield', 'alpha', 0, stepCrochet*0.001*4, 'cubeOut')
    ...
    elseif state == 'doubleshield' then 
        ...
        tweenActorProperty('bfShield', 'alpha', 0, stepCrochet*0.001*8, 'cubeOut')
        tweenActorProperty('mattShield', 'alpha', 0, stepCrochet*0.001*8, 'cubeOut')
    ...
    elseif state == 'tko-powerup' then 
        ...
        tweenActorProperty('aura', 'alpha', 0, stepCrochet*0.001*8, 'cubeOut')
...
function startState(value1)
    ...
    elseif value1 == 'duet' then
        ...
        disableRanged = true
        disableBlock = true
        tweenActorProperty('dadCharacter0', 'x', defaultMattX-130+(pushDist*5), stepCrochet*0.001*4, 'cubeIn')
        tweenActorProperty('bfCharacter0', 'x', defaultBFX+130+(pushDist*5), stepCrochet*0.001*4, 'cubeIn')
    elseif value1 == 'duet-tko' then
        doSplahes = true
        disableRanged = true
        disableBlock = true
        tweenActorProperty('dad', 'x', defaultMattX+(pushDist*5)+100, stepCrochet*0.001*4, 'cubeIn')
        tweenActorProperty('boyfriend', 'x', defaultBFX+(pushDist*5)-100, stepCrochet*0.001*4, 'cubeIn')
    elseif value1 == 'tko-closeup' then
        disableRanged = true
        disableBlock = false
        tweenActorProperty('dad', 'x', defaultMattX+(pushDist*5)+290, stepCrochet*0.001*4, 'cubeIn')
        tweenActorProperty('boyfriend', 'x', defaultBFX+(pushDist*5)-290, stepCrochet*0.001*4, 'cubeIn')
    elseif value1 == 'tko-bfmoveright' then
        disableBlock = false
        disableRanged = false
        tweenActorProperty('boyfriend', 'x', defaultBFX+(pushDist*5)+200, stepCrochet*0.001*31, 'cubeIn')
    elseif value1 == 'tko-mattmoveleft' then
        disableBlock = false
        disableRanged = false
        tweenActorProperty('dad', 'x', defaultMattX+(pushDist*5)-200, stepCrochet*0.001*31, 'cubeIn')
    elseif value1 == 'shield' then 
        ...
        tweenActorProperty('mattShield', 'alpha', 1, stepCrochet*0.001*4, 'cubeIn')
        setActorX(defaultMattX+(pushDist*5)+350, 'mattShield')

        tweenActorProperty('dadCharacter0', 'x', defaultMattX-50+(pushDist*5), stepCrochet*0.001*4, 'cubeIn')
        tweenActorProperty('bfCharacter0', 'x', defaultBFX+70+(pushDist*5), stepCrochet*0.001*4, 'cubeIn')
        --playDadParryAnims = true
        doSplahes = true
    ...
    elseif value1 == 'bfshield' then 
        ...
        tweenActorProperty('bfShield', 'alpha', 1, stepCrochet*0.001*4, 'cubeIn')
        setActorX(defaultBFX+(pushDist*5)-500, 'bfShield')

        
        --tweenActorProperty('dadCharacter4', 'x', , crochet*0.001*8, 'cubeIn')
        tweenActorProperty('bfCharacter0', 'x', defaultBFX-50+(pushDist*5), stepCrochet*0.001*4, 'cubeIn')
        tweenActorProperty('dadCharacter0', 'x', defaultMattX-500+(pushDist*5), stepCrochet*0.001*4, 'cubeIn')
        doDadSplashes = true
        disableHealthDrain = true
    elseif value1 == 'echoInFront' then
        ...
        tweenActorProperty('dadCharacter0', 'x', defaultMattX+(pushDist*5), stepCrochet*0.001*8, 'cubeIn')
        tweenActorProperty('dadCharacter1', 'x', defaultMattX+(pushDist*5)-450, stepCrochet*0.001*8, 'cubeOut')
    ...
    elseif value1 == 'echoInFront-tko' then
        ...
        tweenActorProperty('dad', 'x', defaultMattX+(pushDist*5)+290, stepCrochet*0.001*8, 'cubeIn')
        tweenActorProperty('dadCharacter1', 'x', defaultMattX+(pushDist*5)+290-450, stepCrochet*0.001*8, 'cubeOut')
        tweenActorProperty('boyfriend', 'x', defaultBFX+(pushDist*5)-290, stepCrochet*0.001*4, 'cubeIn')
        --tweenActorProperty('dad', 'x', getOriginalCharX(1)-450+(pushDist*5), crochet*0.001*8, 'cubeOut')
    elseif value1 == 'doubleshield' then 
        ...
        tweenActorProperty('bfShield', 'alpha', 1, stepCrochet*0.001*4, 'cubeIn')
        setActorX(defaultMattX+(pushDist*5)+50, 'bfShield')
        tweenActorProperty('mattShield', 'alpha', 1, stepCrochet*0.001*4, 'cubeIn')
        setActorX(defaultBFX+(pushDist*5)-400, 'mattShield')
        tweenActorProperty('dadCharacter0', 'x', defaultMattX+2550+(pushDist*5), stepCrochet*0.001*8, 'cubeIn')
        tweenActorProperty('bfCharacter0', 'x', defaultBFX+200+(pushDist*5), stepCrochet*0.001*8, 'cubeIn')
        doSplahes = true
        doDadSplashes = true
        disableHealthDrain = true
    elseif value1 == 'resetpush' then
        pushDist = 0
        tweenActorProperty('dad', 'x', defaultMattX+(pushDist*5), stepCrochet*0.001*4, 'cubeOut')
    ...
    elseif value1 == 'tko-powerup' then 
        ...
        tweenActorProperty('boyfriend', 'x', currentBFPos+100, stepCrochet*0.001*8, 'cubeIn')
        tweenActorProperty('dadCharacter0', 'x', currentMattPos+200, stepCrochet*0.001*8, 'cubeIn')
        tweenActorProperty('dadCharacter1', 'x', currentMattPos-800+300, stepCrochet*0.001*8, 'cubeIn')
    ...
    elseif state == 'tko-powerupEnd' then 
        ...
        setActorX(currentBFPos, 'boyfriend')
        tweenActorProperty('boyfriend', 'x', currentBFPos-200, stepCrochet*0.001*8, 'cubeIn')
        tweenActorProperty('dad', 'x', defaultMattX+(pushDist*5)+290, stepCrochet*0.001*8, 'cubeOut')
        --tweenActorProperty('boyfriend', 'x', defaultBFX+(pushDist*5), crochet*0.001*4, 'cubeOut')
    else 
        disableRanged = false
        disableBlock = false
