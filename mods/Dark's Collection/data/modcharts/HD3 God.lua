...
function stepHit(curStep)
    ...
    elseif curStep == 288 or curStep == 1616 or curStep == 1048 then
        tweenShaderProperty('mirrorGame', 'x', 0.5, stepCrochet*0.001*2, 'cubeInOut')
        triggerEvent('Set Camera Zoom','1.1','1')
    elseif curStep == 320 or curStep == 1632 or curStep == 1084 then
    ...
    if curStep == 1280 or curStep == 2944 then
        if not middlescroll then
            for i = 1,9 do 
                for i = 1,9 do
    ...
    if curStep == 1340 or curStep == 3004 then
        if not middlescroll then
    ...
    if curStep == 1152 or curStep == 1664 or curStep == 1792 or curStep == 2816 or curStep == 3328 then
        if not middlescroll then
            for i = 13,18 do
    ...
    if curStep == 1212 or curStep == 1722 or curStep == 1852 or curStep == 2876 or curStep == 3452 then
        if not middlescroll then
            for i = 13,18 do
    ...
    if curStep == 3712 then
        triggerEvent('Screen Shake','2.5,0.04','')
        tweenShaderProperty('mirrorGame', 'zoom', 0.7, stepCrochet*0.001*4, 'cubeIn')
    ...
    elseif curStep == 3728 or curStep == 3872 then
        tweenShaderProperty('mirrorGame', 'y', 7, crochet*0.001*2, 'cubeOut')
    elseif curStep == 3744 or curStep == 3808 or curStep == 3904 or curStep == 4032 then
        tweenShaderProperty('mirrorGame', 'y', 8, crochet*0.001*2, 'cubeOut')
    elseif curStep == 3792 or curStep == 4000 then
        tweenShaderProperty('mirrorGame', 'y', 9, crochet*0.001*2, 'cubeOut')
    end
    if curStep == 32 then
    ...
    if curStep == 3584 then
        if not middlescroll then
            for i = 0,8 do
                tweenActorProperty(i,"alpha",0.3,1,"linear")
            end
            for i = 13,18 do
                tweenActorProperty(i,"alpha",0,1,"linear")
                tweenActorProperty(i,"x",_G["defaultStrum"..i.."X"]-320,0.5,"linear")
            end
            for i = 9,12 do
                tweenActorProperty(i,"x",_G["defaultStrum"..i.."X"]-220,0.5,"linear")
            end
        end
    end
    if curStep == 3712 then
    ...
    if curStep == 3840 then
        if not middlescroll then
            for i = 13,18 do
                tweenActorProperty(i,"alpha",1,0.3,"linear")
            end
        end
    end
    if curStep == 4096 then
