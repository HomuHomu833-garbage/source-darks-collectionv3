...
function stepHit( step )
	...
	elseif curStep == 2256 or curStep == 2320 or curStep == 2528 or curStep == 2576 then
		tweenShaderProperty('mirrorGame', 'zoom', 0.7, stepCrochet*0.001*4, 'cubeIn')
	elseif curStep == 2288 or curStep == 2352 or curStep == 2560 or curStep == 2608 then
		tweenShaderProperty('mirrorGame', 'zoom', 1, crochet*0.001*4, 'cubeInOut')
	elseif curStep == 2368 or curStep == 2624 then
		tweenShaderProperty('mirrorGame', 'x', 3, stepCrochet*0.001*4, 'cubeInOut')
