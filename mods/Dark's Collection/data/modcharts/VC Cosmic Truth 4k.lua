...
-- texto bring in the ruckus
    ...
    makeSprite('bring', 'Cosmic Truth/bring', -650, 150, 0.9)
    setObjectCamera('bring', 'hud')
    setActorAlpha(1, "bring")

    makeSprite('in', 'Cosmic Truth/in', 220, -200, 0.9)
    setObjectCamera('in', 'hud')
    setActorAlpha(1, "in")

    makeSprite('the', 'Cosmic Truth/the', 1000, 160, 0.9)
    setObjectCamera('the', 'hud')
    setActorAlpha(1, "the")

    makeSprite('ru', 'Cosmic Truth/ru', 190, 700, 0.9)
...
-- shaders and others
    ...
    setShaderProperty('blurmejor', 'loops', 5)
...
function stepHit(step)
    ...
    if curStep == 248 then
        ...
        tweenShaderProperty('blurmejor', 'strength', 10, stepCrochet*0.001*4, 'cubeOut')
    ...
    -- text
    if curStep == 492 then
        tweenActorProperty("bring", 'x', getActorX("bring")+570, stepCrochet*0.001*4, 'expoOut')
        tweenShaderProperty('barrel', 'barrel', 6,crochet*0.001*6,"cubeIn")
    elseif curStep == 496 then
        tweenActorProperty("in", 'y', getActorY("in")+320, stepCrochet*0.001*4, 'expoOut')
    elseif curStep == 500 then
        tweenActorProperty("the", 'x', getActorX("the")-500, stepCrochet*0.001*4, 'expoOut')
    elseif curStep == 504 then
        tweenActorProperty("ru", 'y', getActorY("ru")-280, stepCrochet*0.001*4, 'expoOut')
    elseif curStep == 508 then
        tweenActorProperty("ckus", 'y', getActorY("ckus")-280, stepCrochet*0.001*4, 'expoOut')
    elseif curStep == 512 then
        tweenActorProperty("bring", 'x', getActorX("bring")-570, stepCrochet*0.001*4, 'expoOut')
        tweenActorProperty("in", 'y', getActorY("in")-320, stepCrochet*0.001*4, 'expoOut')
        tweenActorProperty("the", 'x', getActorX("the")+500, stepCrochet*0.001*4, 'expoOut')
    ...
    if curStep == 760 then
        tweenShaderProperty('blurmejor', 'strength', 15, crochet*0.001*2, 'linear')
        tweenActorProperty("Bar Down", 'y', getActorY("Bar Down")-150, crochet*0.001*2, 'linear')
        tweenActorProperty("Bar Up", 'y', getActorY("Bar Up")+150, crochet*0.001*2, 'linear')
    ...
    elseif curStep == 768 then
        ...
        tweenShaderProperty('blurmejor', 'strength', 0, crochet*0.001*16, 'cubeIn')
    ...
    elseif curStep == 1536 then
        ...
        setShaderProperty("blurmejor","strength",15)
        setShaderProperty("greyscale","strength",1)
        tweenShaderProperty('blurmejor', 'strength', 0, crochet*0.001*8, 'cubeIn')
    ...
    elseif curStep == 1792 then
        tweenShaderProperty('MirrorRepeatEffect', 'barrel', 0, crochet*0.001*2, 'cubeOut')
        tweenShaderProperty('blurmejor', 'strength', 0, crochet*0.001*4, 'cubeOut')
        tweenPosOut("Bar Up",0,-450,0.5)
        tweenPosOut("Bar Down",0,-1100,0.5)
        perlinSpeed = 0
        perlinXRange = 0
